...
import StatsSection from './StatsSection'; // Ensure this line is present and not commented out
...
// --- Component ---
// Component version: 2.0.0 (updated layout with grid system)
export default function FeaturesSection() {
  // Use React.useEffect to ensure animations only run on client-side
  const [isClient, setIsClient] = React.useState(false);
  const [version] = React.useState("2.0.0");

  React.useEffect(() => {
    // Set isClient to true only on the client side
    setIsClient(true);
    console.log(`FeaturesSection version ${version} mounted`);
  }, [version]);

  const ClientOnly = ({ children }: { children: React.ReactNode }) => {
    if (!isClient) return <div className="opacity-0"></div>;
    return <>{children}</>;
  };
    ...
    <section className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Comprehensive Learning <span className="text-indigo-600">Experience</span>
          </motion.h1>
          <motion.p
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            designed to accelerate your learning and career advancement.
          </motion.p>
        </div>
        ...
        <motion.div
          ...
          className="relative max-w-5xl mx-auto mb-28" // Increased bottom margin
        >
              ...
              <div className="relative mt-16 px-4">
                ...
                <div className="flex flex-col md:flex-row items-start justify-between space-y-16 md:space-y-0 md:space-x-4">
                  {learningPathSteps.map((item, index) => (
                    ...
                    >
                      {/* Numbered circle with improved visual */}
                      <div className="relative mb-5 transform transition-transform duration-300 hover:scale-110">
                        {isClient ? (
                          ...
                          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-400 to-purple-400 blur-md opacity-60"></div>
                        )}
                      ...
                      {/* Title with improved highlight effect */}
                      ...
                      <p className="text-sm text-gray-600 max-w-[220px] leading-relaxed">{item.description}</p>
                    </motion.div>
                  ))}
                </div>
              </div>

              {/* Image now below the steps on all screens */}
              <div className="mt-16 relative group">
                ...
                <div className="relative overflow-hidden rounded-xl">
                  <Image
                    ...
                    alt="Diagram illustrating the four steps of the Learning Expert learning journey: Skill Assessment, Personalized Path, Hands-on Practice, Expert Feedback."
                    width={960}
                    height={500}
                    loading="eager"
                    priority
                  ...
                  >
                    ...
                    <CardFooter className="pb-4 px-6 pt-0">
                      <Button
                        ...
                        size="sm"
                        endContent={<span className="group-hover:translate-x-1 transition-transform duration-300"><ArrowRightIcon /></span>}
                      >
                        Learn more
                      </Button>
                    </CardFooter>
